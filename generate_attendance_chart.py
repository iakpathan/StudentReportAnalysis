...
cursor.execute("SELECT class_name, percentage FROM attendance WHERE roll_no = %s AND semester = %s", (roll_no, semester))
...
# Extract class names and attendance percentages
...
plt.title(f'Attendance Chart for Roll No {roll_no} Semester {semester}')
plt.xlabel('Classes')
